// MUI Color customization tool, borrowed from the MUI docs
// src: https://github.com/mui-org/material-ui/blob/0da2f4a39e1821d76c93ae198d440e5082b10f78/docs/src/pages/customization/color/ColorTool.js
            ...
            <Grid item xs={12} sm={6} md={4}>
                ...
                <Box sx={{ width: 192 }}>
                    {hues.map((hue) => {
                        ...
                        return (
                            <Tooltip placement="bottom" title={hue} key={hue}>
                                <TooltipRadio
                                    sx={{ p: 0 }}
                                    color="default"
